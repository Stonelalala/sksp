 ...
 * 获取询价记录
 */
export function getAskPrice(page = 1, limit = 10){
  return request.get('user/askPrices',{page:page, limit:limit})
}
export function AskPriceReaded(id){
  return request.post('user/agentRead',{id:id});
}